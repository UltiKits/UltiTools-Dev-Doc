...
#
# Zero-argument mode is what docs-ci.yml's `build` job calls, immediately
# after `npm run build`, following scripts/check-rendered-links.sh's pattern
# — no separate job, no live URL needed for the CI gate itself.
#
